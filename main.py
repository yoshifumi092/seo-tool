...
deletion_comment は1文で完結させること。条文のフルテキスト引用は絶対禁止。
条文テーブルに該当する法的根拠がある場合は積極的に組み込むこと。該当なしの場合のみ省略可。

法的根拠あり：〔問題となる行為・表現〕は〔問題の本質〕にあたり、〔法令名〕第〔条番号〕（〔条名称〕）に該当する可能性がある。
法的根拠なし：〔問題となる行為・表現〕は〔問題の本質〕にあたる。

出力例：
「商標名で流入した読者を競合サービスへ誘導する構成は不正な集客誘導にあたり、不正競争防止法第2条第1項第21号（営業誹謗行為）に該当する可能性がある。」
「根拠を示さずに「詐欺まがい」と断定する記述は社会的評価を不当に低下させる表現にあたり、刑法第230条第1項（名誉毀損）に該当する可能性がある。」
...
{{
  ...
  "violations": [
    {{
      ...
      "deletion_comment": "〔問題となる行為・表現〕は〔問題の本質〕にあたり、〔法令名〕第〔条番号〕（〔条名称〕）に該当する可能性がある。"
    }}
  ],
...
async def _call_claude_once(
    ...
    system_prompt = (
        ...
        "【最重要ルール】deletion_comment は1文で完結させること：\n"
        "法的根拠あり→〔行為〕は〔問題の本質〕にあたり、〔法令名〕第〔条番号〕（〔条名称〕）に該当する可能性がある。\n"
        "法的根拠なし→〔行為〕は〔問題の本質〕にあたる。\n"
        "条文テーブルに該当がある場合は積極的に組み込むこと。\n"
        "例：「商標名で流入した読者を競合サービスへ誘導する構成は不正な集客誘導にあたり、"
        "不正競争防止法第2条第1項第21号（営業誹謗行為）に該当する可能性がある。」\n"
