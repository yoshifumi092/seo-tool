...
第3段階: 以下の問題類型から最も適切なものを選んで分類する
  ...
  D: 商標権侵害・不正競争
     ...
     ② 比較誹謗型：対象を否定的に描いた上で競合・代替サービスを推奨する比較コンテンツ
        → 「〇〇より△△の方が安全」「本当におすすめはこちら」等の誘導があれば強い論点になる
     ③ ブランド毀損：対象のブランドイメージを組織的・継続的に傷つける意図が推察される表現・構成
        → 記事全体が「ブランドへの信頼を破壊する」構成になっているかを見る
  ...
  G: 印象操作・ミスリード
     ...
     → 記事全体が「否定的結論ありき」で情報を選別している構成も強い論点となる
