...
deletion_comment は簡潔な2文構成。各文は短く。条文フルテキスト引用は絶対禁止。
法的根拠がある場合は1文目に必ず記載。該当なしの場合は1文のみ。

法的根拠あり：
1文目（20文字以内）：〔法令名〕第〔条番号〕（〔条名称〕）に該当する可能性がある。
2文目（30文字以内）：〔行為〕は〔問題の本質〕にあたる。

法的根拠なし（1文のみ・30文字以内）：〔行為〕は〔問題の本質〕にあたる。

出力例：
「不正競争防止法第2条第1項（営業誹謗行為）に該当する可能性がある。商標名を使った競合誘導にあたる。」
「刑法第230条第1項（名誉毀損）に該当する可能性がある。根拠なき断定で社会的評価を低下させる表現にあたる。」
「法的根拠なしの例：一方的なネガティブ情報の選別掲載にあたる。」
...
{{
  ...
  "violations": [
    {{
      ...
      "deletion_comment": "〔法令名〕第〔条番号〕（〔条名称〕）に該当する可能性がある。〔行為〕は〔問題の本質〕にあたる。"
    }}
  ],
...
async def _call_claude_once(
    ...
    system_prompt = (
        ...
        "【最重要ルール】deletion_comment は短い2文構成：\n"
        "法的根拠あり→1文目：〔法令名〕第〔条番号〕（〔条名称〕）に該当する可能性がある。2文目（30文字以内）：〔行為〕は〔問題の本質〕にあたる。\n"
        "法的根拠なし→1文のみ（30文字以内）：〔行為〕は〔問題の本質〕にあたる。\n"
        "例：「不正競争防止法第2条第1項（営業誹謗行為）に該当する可能性がある。商標名を使った競合誘導にあたる。」\n"
